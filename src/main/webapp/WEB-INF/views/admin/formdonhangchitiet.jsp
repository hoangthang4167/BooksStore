...
<div class="wrapper">
    ...
    <div class="main-panel">
        <div class="content">
            <div class="container-fluid">
                <h4 class="page-title">Quản Lí Đơn Hàng Chi Tiết
                    <table></table>
                </h4>
                <div class="row">
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="d-flex justify-content-center">
                            <a class="btn btn-primary mx-auto text-white" href="/donhangchitiet?p=0">Về Đầu</a>
                            <a class="btn btn-primary mx-auto text-white" href="/donhangchitiet?p=${page.number-1}">Lùi</a>
                            <a class="btn btn-primary mx-auto text-white" href="/donhangchitiet?p=${page.number+1}">Tiến</a>
                            <a class="btn btn-primary mx-auto text-white" href="/donhangchitiet?p=${page.totalPages-1}">Về Cuối</a>
                        </div>
