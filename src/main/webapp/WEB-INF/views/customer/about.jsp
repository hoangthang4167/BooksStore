        ...
        <div class="container">
            <div class="row mb-5">
                <div class="col-md-6">
                    <div class="block-16">
                        <figure>
                            <img src="/static/customer/images/about.jpg" alt="Image placeholder"
                ...
                <div class="col-md-5">
                    ...
                    <p>Lựa chọn đa dạng: Trang web bán sách của bạn có thể cung cấp một lựa chọn đa dạng về sách mới và
                        đã qua sử dụng từ các nguồn độc lập trên toàn thế giới.</p>
                    <p>Tiếp cận độc giả: Một trang web bán sách có thể giúp bạn tiếp cận với độc giả tiềm năng và xây
                        dựng mối quan hệ với họ.</p>
            ...
            <div class="row">
                    ...
                    <div class="block-38 text-center">
                        <div class="block-38-img">
                            ...
                            <div class="block-38-body">
                                <p>Sinh ra và lớn lên tại Hoài Mỹ, Hoài Nhơn, Bình Định một vùng đất đầy nắng và gió.
                                    Đang theo học tại FPT PolyTechnic </p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-6">
                    <div class="block-38 text-center">
                        <div class="block-38-img">
                            <div class="block-38-header">
                                <img src="/static/customer/images/thang.jpg" alt="Image placeholder" class="mb-4">
                                <h3 class="block-38-heading h4">Nguyễn Lê Hoàng Thắng</h3>
                                <p class="block-38-subheading">Co-Founder</p>
                            </div>
                            <div class="block-38-body">
                                <p>Đang theo học tại FPT PolyTechnic </p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-6">
                    <div class="block-38 text-center">
                        <div class="block-38-img">
                            <div class="block-38-header">
                                <img src="/static/customer/images/truong.jpg" alt="Image placeholder" class="mb-4">
                                <h3 class="block-38-heading h4">Nguyễn Minh Trường</h3>
                                <p class="block-38-subheading">Co-Founder</p>
                            </div>
                            <div class="block-38-body">
                                <p>Đang theo học tại FPT PolyTechnic </p>
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="block-38 text-center">
                        <div class="block-38-img">
                            <div class="block-38-header">
                                <img src="/static/customer/images/tuoi.jpg" alt="Image placeholder" class="mb-4">
                                <h3 class="block-38-heading h4">Nguyễn Ngọc Tươi</h3>
                                <p class="block-38-subheading">Co-Founder</p>
                            </div>
                            <div class="block-38-body">
                                <p>Đang theo học tại FPT PolyTechnic </p>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4 d-lg-flex mb-4 mb-lg-0 pl-4" data-aos="fade-up" data-aos-delay="">
                    ...
                    <div class="text">
                        ...
                        <p>Mọi sản phẩm của Cửa Hàng khi đặt hàng trực tuyến đều được miễn phí vận chuyển. Nếu có phát
                            sinh phí vận chuyển vui lòng liên hệ Cửa Hàng.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4 d-lg-flex mb-4 mb-lg-0 pl-4" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="text">
                        ...
                        <p>Mọi sản phẩm của Cửa Hàng khi nhận hàng nếu cảm thấy không hài lòng có thể trả lại cho cửa
                            hàng. Mọi chi phí về vấn đề trả hàng đều được Cửa Hàng chi trả và hoàn toàn miễn phí.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4 d-lg-flex mb-4 mb-lg-0 pl-4" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="text">
                        ...
                        <p>Chúng tôi luôn hỗ trợ khách hàng về mọi vấn đề khách hàng gặp phải trong quá trình mua sản
                            phẩm của Cửa Hàng chúng tôi.</p>
                    </div>
                </div>
            </div>
        </div>
